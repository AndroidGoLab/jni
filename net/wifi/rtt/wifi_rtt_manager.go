...
// ToString calls android.net.wifi.rtt.WifiRttManager.toString.
func (m *WifiRttManager) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midWifiRttManagerToString == nil {
			callErr = fmt.Errorf("android.net.wifi.rtt.WifiRttManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWifiRttManagerToString,
		)
		if callErr != nil {
			return callErr
		}
