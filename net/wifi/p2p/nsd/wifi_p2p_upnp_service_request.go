...
func (m *WifiP2pUpnpServiceRequest) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midWifiP2pUpnpServiceRequestToString == nil {
			callErr = fmt.Errorf("android.net.wifi.p2p.nsd.WifiP2pUpnpServiceRequest.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWifiP2pUpnpServiceRequestToString,
		)
		if callErr != nil {
			return callErr
		}
