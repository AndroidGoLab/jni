...
func (m *WifiP2pUpnpServiceInfo) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midWifiP2pUpnpServiceInfoToString == nil {
			callErr = fmt.Errorf("android.net.wifi.p2p.nsd.WifiP2pUpnpServiceInfo.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWifiP2pUpnpServiceInfoToString,
		)
		if callErr != nil {
			return callErr
		}
