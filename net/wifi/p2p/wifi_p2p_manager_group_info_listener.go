...
func (m *WifiP2pManagerGroupInfoListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midWifiP2pManagerGroupInfoListenerToString == nil {
			callErr = fmt.Errorf("android.net.wifi.p2p.WifiP2pManager$GroupInfoListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWifiP2pManagerGroupInfoListenerToString,
		)
		if callErr != nil {
			return callErr
		}
