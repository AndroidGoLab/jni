...
// ToString calls android.net.SSLSessionCache.toString.
func (m *SSLSessionCache) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSSLSessionCacheToString == nil {
			callErr = fmt.Errorf("android.net.SSLSessionCache.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSSLSessionCacheToString,
		)
		if callErr != nil {
			return callErr
		}
