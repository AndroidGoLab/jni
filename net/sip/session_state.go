...
func (m *SessionState) ToString(arg0 int32) (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSessionStateToString == nil {
			callErr = fmt.Errorf("android.net.sip.SipSession$State.toString is not available on this device")
			return callErr
		}

		var resultObj *jni.Object
		resultObj, callErr = env.CallStaticObjectMethod(
			(*jni.Class)(unsafe.Pointer(clsSessionState)),
			midSessionStateToString, jni.IntValue(arg0),
		)
		if callErr != nil {
			return callErr
		}
