...
func doInit(env *jni.Env) error {
	...
	if err != nil {
		...
		midAudioCallInit, err = env.GetMethodID((*jni.Class)(unsafe.Pointer(clsAudioCall)), "<init>", "(Landroid/content/Context;Landroid/net/sip/SipProfile;)V")
		if err != nil {
			env.ExceptionClear()
		}
