...
func (m *IkeSaProposal) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midIkeSaProposalToString == nil {
			callErr = fmt.Errorf("android.net.ipsec.ike.IkeSaProposal.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midIkeSaProposalToString,
		)
		if callErr != nil {
			return callErr
		}
