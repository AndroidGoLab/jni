...
func (m *IkeProtocolException) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midIkeProtocolExceptionToString == nil {
			callErr = fmt.Errorf("android.net.ipsec.ike.exceptions.IkeProtocolException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midIkeProtocolExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
