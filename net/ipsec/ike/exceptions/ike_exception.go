...
func (m *IkeException) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midIkeExceptionToString == nil {
			callErr = fmt.Errorf("android.net.ipsec.ike.exceptions.IkeException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midIkeExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
