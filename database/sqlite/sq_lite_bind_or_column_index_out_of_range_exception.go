...
func NewSQLiteBindOrColumnIndexOutOfRangeException(vm *jni.VM) (*SQLiteBindOrColumnIndexOutOfRangeException, error) {
	var t SQLiteBindOrColumnIndexOutOfRangeException
	t.VM = vm
...
// ToString calls android.database.sqlite.SQLiteBindOrColumnIndexOutOfRangeException.toString.
func (m *SQLiteBindOrColumnIndexOutOfRangeException) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSQLiteBindOrColumnIndexOutOfRangeExceptionToString == nil {
			callErr = fmt.Errorf("android.database.sqlite.SQLiteBindOrColumnIndexOutOfRangeException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSQLiteBindOrColumnIndexOutOfRangeExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
