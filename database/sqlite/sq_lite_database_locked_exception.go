...
func NewSQLiteDatabaseLockedException(vm *jni.VM) (*SQLiteDatabaseLockedException, error) {
	var t SQLiteDatabaseLockedException
	t.VM = vm
...
// ToString calls android.database.sqlite.SQLiteDatabaseLockedException.toString.
func (m *SQLiteDatabaseLockedException) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSQLiteDatabaseLockedExceptionToString == nil {
			callErr = fmt.Errorf("android.database.sqlite.SQLiteDatabaseLockedException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSQLiteDatabaseLockedExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
