...
func NewSQLiteBlobTooBigException(vm *jni.VM) (*SQLiteBlobTooBigException, error) {
	var t SQLiteBlobTooBigException
	t.VM = vm
...
// ToString calls android.database.sqlite.SQLiteBlobTooBigException.toString.
func (m *SQLiteBlobTooBigException) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSQLiteBlobTooBigExceptionToString == nil {
			callErr = fmt.Errorf("android.database.sqlite.SQLiteBlobTooBigException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSQLiteBlobTooBigExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
