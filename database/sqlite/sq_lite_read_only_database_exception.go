...
func NewSQLiteReadOnlyDatabaseException(vm *jni.VM) (*SQLiteReadOnlyDatabaseException, error) {
	var t SQLiteReadOnlyDatabaseException
	t.VM = vm
...
// ToString calls android.database.sqlite.SQLiteReadOnlyDatabaseException.toString.
func (m *SQLiteReadOnlyDatabaseException) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSQLiteReadOnlyDatabaseExceptionToString == nil {
			callErr = fmt.Errorf("android.database.sqlite.SQLiteReadOnlyDatabaseException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSQLiteReadOnlyDatabaseExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
