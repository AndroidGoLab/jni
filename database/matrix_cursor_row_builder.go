...
func (m *MatrixCursorRowBuilder) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midMatrixCursorRowBuilderToString == nil {
			callErr = fmt.Errorf("android.database.MatrixCursor$RowBuilder.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midMatrixCursorRowBuilderToString,
		)
		if callErr != nil {
			return callErr
		}
