...
func (m *SleepSessionRecordStageType) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSleepSessionRecordStageTypeToString == nil {
			callErr = fmt.Errorf("android.health.connect.datatypes.SleepSessionRecord$StageType.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSleepSessionRecordStageTypeToString,
		)
		if callErr != nil {
			return callErr
		}
