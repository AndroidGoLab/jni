...
func (m *BloodPressureRecordBodyPosition) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midBloodPressureRecordBodyPositionToString == nil {
			callErr = fmt.Errorf("android.health.connect.datatypes.BloodPressureRecord$BodyPosition.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midBloodPressureRecordBodyPositionToString,
		)
		if callErr != nil {
			return callErr
		}
