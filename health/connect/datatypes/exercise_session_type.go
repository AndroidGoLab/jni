...
func (m *ExerciseSessionType) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midExerciseSessionTypeToString == nil {
			callErr = fmt.Errorf("android.health.connect.datatypes.ExerciseSessionType.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midExerciseSessionTypeToString,
		)
		if callErr != nil {
			return callErr
		}
