...
func (m *PlannedExerciseBlock) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midPlannedExerciseBlockToString == nil {
			callErr = fmt.Errorf("android.health.connect.datatypes.PlannedExerciseBlock.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midPlannedExerciseBlockToString,
		)
		if callErr != nil {
			return callErr
		}
