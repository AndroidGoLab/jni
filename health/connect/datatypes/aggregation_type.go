...
func (m *AggregationType) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAggregationTypeToString == nil {
			callErr = fmt.Errorf("android.health.connect.datatypes.AggregationType.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAggregationTypeToString,
		)
		if callErr != nil {
			return callErr
		}
