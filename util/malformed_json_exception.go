...
// ToString calls android.util.MalformedJsonException.toString.
func (m *MalformedJsonException) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midMalformedJsonExceptionToString == nil {
			callErr = fmt.Errorf("android.util.MalformedJsonException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midMalformedJsonExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
