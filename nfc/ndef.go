...
// ToString calls android.nfc.tech.Ndef.toString.
func (m *Ndef) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midNdefToString == nil {
			callErr = fmt.Errorf("android.nfc.tech.Ndef.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
