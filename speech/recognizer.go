...
// ToString calls android.speech.SpeechRecognizer.toString.
func (m *Recognizer) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midRecognizerToString == nil {
			callErr = fmt.Errorf("android.speech.SpeechRecognizer.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midRecognizerToString,
		)
		if callErr != nil {
			return callErr
		}
