...
func doInit(env *jni.Env) error {
	...
	if err != nil {
		return fmt.Errorf("find class android.speech.tts.TextToSpeechService: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.speech.tts.SynthesisRequest: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.speech.tts.Voice: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.speech.tts.SynthesisCallback: %w", err)
	}
