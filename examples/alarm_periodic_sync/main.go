...
// Command alarm_periodic_sync demonstrates the AlarmManager system service.
// It shows alarm type constants, interval constants, and checks whether
// exact alarms can be scheduled.
package main
