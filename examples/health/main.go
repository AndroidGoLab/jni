...
func run(vm *jni.VM, output *bytes.Buffer) error {
	...
	case initErr == nil:
		...
		fmt.Fprintln(output)
		fmt.Fprintln(output, "Note: insertRecords, readRecords,")
		fmt.Fprintln(output, "aggregate, deleteRecords are Kotlin")
		fmt.Fprintln(output, "suspend functions and require a")
		fmt.Fprintln(output, "callback/ListenableFuture adapter.")
	default:
