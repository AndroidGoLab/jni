...
func (m *WrapTogetherSpan) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midWrapTogetherSpanToString == nil {
			callErr = fmt.Errorf("android.text.style.WrapTogetherSpan.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWrapTogetherSpanToString,
		)
		if callErr != nil {
			return callErr
		}
