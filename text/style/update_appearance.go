...
func (m *UpdateAppearance) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUpdateAppearanceToString == nil {
			callErr = fmt.Errorf("android.text.style.UpdateAppearance.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUpdateAppearanceToString,
		)
		if callErr != nil {
			return callErr
		}
