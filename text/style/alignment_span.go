...
func (m *AlignmentSpan) GetAlignment() (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAlignmentSpanGetAlignment == nil {
			callErr = fmt.Errorf("android.text.style.AlignmentSpan.getAlignment is not available on this device")
			return callErr
		}
		result, callErr = env.CallObjectMethod(
			m.Obj,
			midAlignmentSpanGetAlignment,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *AlignmentSpan) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAlignmentSpanToString == nil {
			callErr = fmt.Errorf("android.text.style.AlignmentSpan.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAlignmentSpanToString,
		)
		if callErr != nil {
			return callErr
		}
