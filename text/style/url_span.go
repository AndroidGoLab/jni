...
func (m *URLSpan) DescribeContents() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midURLSpanDescribeContents == nil {
			callErr = fmt.Errorf("android.text.style.URLSpan.describeContents is not available on this device")
			return callErr
		}
		result, callErr = env.CallIntMethod(
			m.Obj,
			midURLSpanDescribeContents,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *URLSpan) GetSpanTypeId() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midURLSpanGetSpanTypeId == nil {
			callErr = fmt.Errorf("android.text.style.URLSpan.getSpanTypeId is not available on this device")
			return callErr
		}
		result, callErr = env.CallIntMethod(
			m.Obj,
			midURLSpanGetSpanTypeId,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *URLSpan) GetURL() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midURLSpanGetURL == nil {
			callErr = fmt.Errorf("android.text.style.URLSpan.getURL is not available on this device")
			return callErr
		}
...
func (m *URLSpan) OnClick(arg0 *jni.Object) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midURLSpanOnClick == nil {
			callErr = fmt.Errorf("android.text.style.URLSpan.onClick is not available on this device")
			return callErr
		}

		callErr = env.CallVoidMethod(
			m.Obj,
			midURLSpanOnClick, jni.ObjectValue(arg0),
		)
		return callErr
	})
	return callErr
...
func (m *URLSpan) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midURLSpanToString == nil {
			callErr = fmt.Errorf("android.text.style.URLSpan.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
...
func (m *URLSpan) WriteToParcel(arg0 *jni.Object, arg1 int32) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midURLSpanWriteToParcel == nil {
			callErr = fmt.Errorf("android.text.style.URLSpan.writeToParcel is not available on this device")
			return callErr
		}

		callErr = env.CallVoidMethod(
			m.Obj,
			midURLSpanWriteToParcel, jni.ObjectValue(arg0), jni.IntValue(arg1),
		)
		return callErr
	})
	return callErr
