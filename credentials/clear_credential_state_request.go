...
func (m *ClearCredentialStateRequest) DescribeContents() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midClearCredentialStateRequestDescribeContents == nil {
			callErr = fmt.Errorf("android.credentials.ClearCredentialStateRequest.describeContents is not available on this device")
			return callErr
		}
...
func (m *ClearCredentialStateRequest) GetData() (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midClearCredentialStateRequestGetData == nil {
			callErr = fmt.Errorf("android.credentials.ClearCredentialStateRequest.getData is not available on this device")
			return callErr
		}
...
func (m *ClearCredentialStateRequest) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midClearCredentialStateRequestToString == nil {
			callErr = fmt.Errorf("android.credentials.ClearCredentialStateRequest.toString is not available on this device")
			return callErr
		}
...
func (m *ClearCredentialStateRequest) WriteToParcel(arg0 *jni.Object, arg1 int32) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midClearCredentialStateRequestWriteToParcel == nil {
			callErr = fmt.Errorf("android.credentials.ClearCredentialStateRequest.writeToParcel is not available on this device")
			return callErr
		}
