...
func (m *IntEvaluator) Evaluate3(
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midIntEvaluatorEvaluate3 == nil {
		...
		result, callErr = env.CallObjectMethod(
			m.Obj,
			midIntEvaluatorEvaluate3, jni.FloatValue(arg0), jni.ObjectValue(arg1), jni.ObjectValue(arg2),
		)
		if callErr != nil {
			return callErr
		}
...
func (m *IntEvaluator) Evaluate3_1(
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midIntEvaluatorEvaluate3_1 == nil {
			callErr = fmt.Errorf("android.animation.IntEvaluator.evaluate is not available on this device")
			return callErr
		}
		...
		result, callErr = env.CallObjectMethod(
			m.Obj,
			midIntEvaluatorEvaluate3_1, jni.FloatValue(arg0), jni.ObjectValue(arg1), jni.ObjectValue(arg2),
		)
		if callErr != nil {
			return callErr
		}
