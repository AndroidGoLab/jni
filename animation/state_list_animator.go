...
func (m *StateListAnimator) AddState(arg0 *jni.Object, arg1 *jni.Object) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midStateListAnimatorAddState == nil {
			callErr = fmt.Errorf("android.animation.StateListAnimator.addState is not available on this device")
			return callErr
		}
...
func (m *StateListAnimator) JumpToCurrentState() error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midStateListAnimatorJumpToCurrentState == nil {
			callErr = fmt.Errorf("android.animation.StateListAnimator.jumpToCurrentState is not available on this device")
			return callErr
		}
		callErr = env.CallVoidMethod(
			m.Obj,
...
func (m *StateListAnimator) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midStateListAnimatorToString == nil {
			callErr = fmt.Errorf("android.animation.StateListAnimator.toString is not available on this device")
			return callErr
		}
