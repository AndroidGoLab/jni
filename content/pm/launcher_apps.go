...
// ToString calls android.content.pm.LauncherApps.toString.
func (m *LauncherApps) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midLauncherAppsToString == nil {
			callErr = fmt.Errorf("android.content.pm.LauncherApps.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midLauncherAppsToString,
		)
		if callErr != nil {
			return callErr
		}
