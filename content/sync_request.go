...
func (m *SyncRequest) DescribeContents() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSyncRequestDescribeContents == nil {
			callErr = fmt.Errorf("android.content.SyncRequest.describeContents is not available on this device")
			return callErr
		}
		result, callErr = env.CallIntMethod(
			m.Obj,
			midSyncRequestDescribeContents,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *SyncRequest) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSyncRequestToString == nil {
			callErr = fmt.Errorf("android.content.SyncRequest.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSyncRequestToString,
		)
		if callErr != nil {
			return callErr
		}
