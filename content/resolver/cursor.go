...
// ToString calls android.database.Cursor.toString.
func (m *Cursor) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midCursorToString == nil {
			callErr = fmt.Errorf("android.database.Cursor.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
