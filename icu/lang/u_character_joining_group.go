...
type UCharacterJoiningGroup struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterJoiningGroup) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterJoiningGroupToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$JoiningGroup.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterJoiningGroupToString,
		)
		if callErr != nil {
			return callErr
		}
