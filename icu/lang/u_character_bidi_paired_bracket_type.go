...
type UCharacterBidiPairedBracketType struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterBidiPairedBracketType) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterBidiPairedBracketTypeToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$BidiPairedBracketType.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterBidiPairedBracketTypeToString,
		)
		if callErr != nil {
			return callErr
		}
