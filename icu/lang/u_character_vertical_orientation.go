...
type UCharacterVerticalOrientation struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterVerticalOrientation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterVerticalOrientationToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$VerticalOrientation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterVerticalOrientationToString,
		)
		if callErr != nil {
			return callErr
		}
