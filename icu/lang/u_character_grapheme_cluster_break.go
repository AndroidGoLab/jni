...
type UCharacterGraphemeClusterBreak struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterGraphemeClusterBreak) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterGraphemeClusterBreakToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$GraphemeClusterBreak.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterGraphemeClusterBreakToString,
		)
		if callErr != nil {
			return callErr
		}
