...
type UCharacterSentenceBreak struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterSentenceBreak) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterSentenceBreakToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$SentenceBreak.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterSentenceBreakToString,
		)
		if callErr != nil {
			return callErr
		}
