...
type UPropertyNameChoice struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UPropertyNameChoice) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUPropertyNameChoiceToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UProperty$NameChoice.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUPropertyNameChoiceToString,
		)
		if callErr != nil {
			return callErr
		}
