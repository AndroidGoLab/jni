...
type UCharacterIndicSyllabicCategory struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterIndicSyllabicCategory) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterIndicSyllabicCategoryToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$IndicSyllabicCategory.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterIndicSyllabicCategoryToString,
		)
		if callErr != nil {
			return callErr
		}
