...
type UCharacterHangulSyllableType struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterHangulSyllableType) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterHangulSyllableTypeToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$HangulSyllableType.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterHangulSyllableTypeToString,
		)
		if callErr != nil {
			return callErr
		}
