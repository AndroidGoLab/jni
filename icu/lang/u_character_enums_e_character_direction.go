...
type UCharacterEnumsECharacterDirection struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterEnumsECharacterDirection) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterEnumsECharacterDirectionToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacterEnums$ECharacterDirection.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterEnumsECharacterDirectionToString,
		)
		if callErr != nil {
			return callErr
		}
