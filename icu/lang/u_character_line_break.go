...
type UCharacterLineBreak struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *UCharacterLineBreak) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUCharacterLineBreakToString == nil {
			callErr = fmt.Errorf("android.icu.lang.UCharacter$LineBreak.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUCharacterLineBreakToString,
		)
		if callErr != nil {
			return callErr
		}
