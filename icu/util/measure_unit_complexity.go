...
func (m *MeasureUnitComplexity) Values() (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midMeasureUnitComplexityValues == nil {
			callErr = fmt.Errorf("android.icu.util.MeasureUnit$Complexity.values is not available on this device")
			return callErr
		}
		result, callErr = env.CallStaticObjectMethod(
			(*jni.Class)(unsafe.Pointer(clsMeasureUnitComplexity)),
			midMeasureUnitComplexityValues,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *MeasureUnitComplexity) ValueOf(arg0 string) (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midMeasureUnitComplexityValueOf == nil {
			callErr = fmt.Errorf("android.icu.util.MeasureUnit$Complexity.valueOf is not available on this device")
			return callErr
		}
		...
		result, callErr = env.CallStaticObjectMethod(
			(*jni.Class)(unsafe.Pointer(clsMeasureUnitComplexity)),
			midMeasureUnitComplexityValueOf, jni.ObjectValue(&jArg0.Object),
		)
		if callErr != nil {
			return callErr
		}
