...
func (m *StreamingServiceInfo) DescribeContents() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midStreamingServiceInfoDescribeContents == nil {
			callErr = fmt.Errorf("android.telephony.mbms.StreamingServiceInfo.describeContents is not available on this device")
			return callErr
		}
		result, callErr = env.CallIntMethod(
			m.Obj,
			midStreamingServiceInfoDescribeContents,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *StreamingServiceInfo) WriteToParcel(arg0 *jni.Object, arg1 int32) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midStreamingServiceInfoWriteToParcel == nil {
			callErr = fmt.Errorf("android.telephony.mbms.StreamingServiceInfo.writeToParcel is not available on this device")
			return callErr
		}

		callErr = env.CallVoidMethod(
			m.Obj,
			midStreamingServiceInfoWriteToParcel, jni.ObjectValue(arg0), jni.IntValue(arg1),
		)
		return callErr
	})
	return callErr
