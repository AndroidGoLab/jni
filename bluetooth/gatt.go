...
// ToString calls android.bluetooth.BluetoothGatt.toString.
func (m *Gatt) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midGattToString == nil {
			callErr = fmt.Errorf("android.bluetooth.BluetoothGatt.toString is not available on this device")
			return callErr
		}
