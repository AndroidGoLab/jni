...
// ToString calls android.bluetooth.BluetoothLeAudio.toString.
func (m *LeAudio) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midLeAudioToString == nil {
			callErr = fmt.Errorf("android.bluetooth.BluetoothLeAudio.toString is not available on this device")
			return callErr
		}
