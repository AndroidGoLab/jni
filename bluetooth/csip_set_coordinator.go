...
// ToString calls android.bluetooth.BluetoothCsipSetCoordinator.toString.
func (m *CsipSetCoordinator) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midCsipSetCoordinatorToString == nil {
			callErr = fmt.Errorf("android.bluetooth.BluetoothCsipSetCoordinator.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midCsipSetCoordinatorToString,
		)
		if callErr != nil {
			return callErr
		}
