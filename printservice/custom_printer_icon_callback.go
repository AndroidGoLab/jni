...
func (m *CustomPrinterIconCallback) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midCustomPrinterIconCallbackToString == nil {
			callErr = fmt.Errorf("android.printservice.CustomPrinterIconCallback.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midCustomPrinterIconCallbackToString,
		)
		if callErr != nil {
			return callErr
		}
