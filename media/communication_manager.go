...
func (m *CommunicationManager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midCommunicationManagerToString == nil {
			callErr = fmt.Errorf("android.media.MediaCommunicationManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midCommunicationManagerToString,
		)
		if callErr != nil {
			return callErr
		}
