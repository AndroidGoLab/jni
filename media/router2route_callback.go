...
func (m *Router2RouteCallback) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midRouter2RouteCallbackToString == nil {
			callErr = fmt.Errorf("android.media.MediaRouter2$RouteCallback.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midRouter2RouteCallbackToString,
		)
		if callErr != nil {
			return callErr
		}
