...
func (m *Router2ScanRequest) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midRouter2ScanRequestToString == nil {
			callErr = fmt.Errorf("android.media.MediaRouter2$ScanRequest.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midRouter2ScanRequestToString,
		)
		if callErr != nil {
			return callErr
		}
