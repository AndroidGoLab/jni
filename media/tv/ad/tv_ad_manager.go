...
// GetTvAdServiceList calls android.media.tv.ad.TvAdManager.getTvAdServiceList.
func (m *TvAdManager) GetTvAdServiceList() (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midTvAdManagerGetTvAdServiceList == nil {
			callErr = fmt.Errorf("android.media.tv.ad.TvAdManager.getTvAdServiceList is not available on this device")
			return callErr
		}
		result, callErr = env.CallObjectMethod(
			m.Obj,
			midTvAdManagerGetTvAdServiceList,
		)
		if callErr != nil {
			return callErr
		}
