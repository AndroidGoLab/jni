...
func (m *TvInteractiveAppManager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midTvInteractiveAppManagerToString == nil {
			callErr = fmt.Errorf("android.media.tv.interactive.TvInteractiveAppManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midTvInteractiveAppManagerToString,
		)
		if callErr != nil {
			return callErr
		}
