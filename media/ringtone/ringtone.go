...
// ToString calls android.media.Ringtone.toString.
func (m *Ringtone) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midRingtoneToString == nil {
			callErr = fmt.Errorf("android.media.Ringtone.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
