...
// ToString calls android.media.midi.MidiUmpDeviceService.toString.
func (m *UmpDeviceService) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midUmpDeviceServiceToString == nil {
			callErr = fmt.Errorf("android.media.midi.MidiUmpDeviceService.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUmpDeviceServiceToString,
		)
		if callErr != nil {
			return callErr
		}
