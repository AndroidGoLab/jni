...
// GetDevicesForTransport calls android.media.midi.MidiManager.getDevicesForTransport.
func (m *Manager) GetDevicesForTransport(arg0 int32) (*jni.Object, error) {
	var result *jni.Object
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midManagerGetDevicesForTransport == nil {
			callErr = fmt.Errorf("android.media.midi.MidiManager.getDevicesForTransport is not available on this device")
			return callErr
		}

		result, callErr = env.CallObjectMethod(
			m.Obj,
			midManagerGetDevicesForTransport, jni.IntValue(arg0),
		)
		if callErr != nil {
			return callErr
		}
...
// ToString calls android.media.midi.MidiManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.media.midi.MidiManager.toString is not available on this device")
			return callErr
		}
