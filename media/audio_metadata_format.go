...
func (m *AudioMetadataFormat) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAudioMetadataFormatToString == nil {
			callErr = fmt.Errorf("android.media.AudioMetadata$Format.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAudioMetadataFormatToString,
		)
		if callErr != nil {
			return callErr
		}
