...
func (m *MuxerOutputFormat) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midMuxerOutputFormatToString == nil {
			callErr = fmt.Errorf("android.media.MediaMuxer$OutputFormat.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midMuxerOutputFormatToString,
		)
		if callErr != nil {
			return callErr
		}
