...
var (
	...
	midManagerCreateScreenCaptureIntent0   jni.MethodID
	midManagerCreateScreenCaptureIntent1_1 jni.MethodID
...
func doInit(env *jni.Env) error {
	...
	midManagerCreateScreenCaptureIntent0, err = env.GetMethodID((*jni.Class)(unsafe.Pointer(clsManager)), "createScreenCaptureIntent", "()Landroid/content/Intent;")
	if err != nil {
		// Method may not exist on this device's API level; skip and
		// report at invocation time instead of failing the entire init.
		env.ExceptionClear()
	...
	midManagerCreateScreenCaptureIntent1_1, err = env.GetMethodID((*jni.Class)(unsafe.Pointer(clsManager)), "createScreenCaptureIntent", "(Landroid/media/projection/MediaProjectionConfig;)Landroid/content/Intent;")
	if err != nil {
		// Method may not exist on this device's API level; skip and
		// report at invocation time instead of failing the entire init.
		env.ExceptionClear()
