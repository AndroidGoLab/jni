...
func (m *ExtractorMetricsConstants) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midExtractorMetricsConstantsToString == nil {
			callErr = fmt.Errorf("android.media.MediaExtractor$MetricsConstants.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midExtractorMetricsConstantsToString,
		)
		if callErr != nil {
			return callErr
		}
