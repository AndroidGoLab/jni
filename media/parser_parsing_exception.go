...
func (m *ParserParsingException) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midParserParsingExceptionToString == nil {
			callErr = fmt.Errorf("android.media.MediaParser$ParsingException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midParserParsingExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
