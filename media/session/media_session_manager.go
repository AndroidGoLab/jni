...
const serviceNameMediaSessionManager = "media_session"
...
func NewMediaSessionManager(ctx *app.Context) (*MediaSessionManager, error) {
	...
	err := mgr.VM.Do(func(env *jni.Env) error {
		...
		svc, err := ctx.GetSystemService(serviceNameMediaSessionManager)
		if err != nil {
			return err
		}
		if svc == nil || svc.Ref() == 0 {
			return fmt.Errorf("%s service not available", serviceNameMediaSessionManager)
		}
...
// ToString calls android.media.session.MediaSessionManager.toString.
func (m *MediaSessionManager) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midMediaSessionManagerToString == nil {
			callErr = fmt.Errorf("android.media.session.MediaSessionManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midMediaSessionManagerToString,
		)
		if callErr != nil {
			return callErr
		}
