...
func (m *ParserTrackData) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midParserTrackDataToString == nil {
			callErr = fmt.Errorf("android.media.MediaParser$TrackData.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midParserTrackDataToString,
		)
		if callErr != nil {
			return callErr
		}
