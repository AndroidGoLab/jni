...
func (m *AudioTrackMetricsConstants) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAudioTrackMetricsConstantsToString == nil {
			callErr = fmt.Errorf("android.media.AudioTrack$MetricsConstants.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAudioTrackMetricsConstantsToString,
		)
		if callErr != nil {
			return callErr
		}
