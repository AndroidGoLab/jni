...
func (m *RemoteControllerMetadataEditor) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midRemoteControllerMetadataEditorToString == nil {
			callErr = fmt.Errorf("android.media.RemoteController$MetadataEditor.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midRemoteControllerMetadataEditorToString,
		)
		if callErr != nil {
			return callErr
		}
