...
func (m *CodecMetricsConstants) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midCodecMetricsConstantsToString == nil {
			callErr = fmt.Errorf("android.media.MediaCodec$MetricsConstants.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midCodecMetricsConstantsToString,
		)
		if callErr != nil {
			return callErr
		}
