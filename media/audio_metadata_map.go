...
func (m *AudioMetadataMap) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAudioMetadataMapToString == nil {
			callErr = fmt.Errorf("android.media.AudioMetadataMap.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAudioMetadataMapToString,
		)
		if callErr != nil {
			return callErr
		}
