...
func (m *DrmOnKeyStatusChangeListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midDrmOnKeyStatusChangeListenerToString == nil {
			callErr = fmt.Errorf("android.media.MediaDrm$OnKeyStatusChangeListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midDrmOnKeyStatusChangeListenerToString,
		)
		if callErr != nil {
			return callErr
		}
