...
// ToString calls android.companion.CompanionDeviceManager.toString.
func (m *DeviceManager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midDeviceManagerToString == nil {
			callErr = fmt.Errorf("android.companion.CompanionDeviceManager.toString is not available on this device")
			return callErr
		}
