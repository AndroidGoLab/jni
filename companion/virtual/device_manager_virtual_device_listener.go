...
type DeviceManagerVirtualDeviceListener struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *DeviceManagerVirtualDeviceListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midDeviceManagerVirtualDeviceListenerToString == nil {
			callErr = fmt.Errorf("android.companion.virtual.VirtualDeviceManager$VirtualDeviceListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midDeviceManagerVirtualDeviceListenerToString,
		)
		if callErr != nil {
			return callErr
		}
