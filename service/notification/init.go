...
func doInit(env *jni.Env) error {
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.Condition: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.ZenPolicy: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.ZenPolicy$Builder: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.ZenDeviceEffects: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.ZenDeviceEffects$Builder: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.NotificationListenerService: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.NotificationListenerService$Ranking: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.NotificationListenerService$RankingMap: %w", err)
	}
	...
	midListenerServiceRankingMapWriteToParcel, err = env.GetMethodID((*jni.Class)(unsafe.Pointer(clsListenerServiceRankingMap)), "writeToParcel", "(Landroid/os/Parcel;I)V")
	if err != nil {
		// Method may not exist on this device's API level; skip and
		// report at invocation time instead of failing the entire init.
		env.ExceptionClear()
	...
	if err != nil {
		return fmt.Errorf("find class android.service.notification.ConditionProviderService: %w", err)
	}
