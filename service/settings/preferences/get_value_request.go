...
func (m *GetValueRequest) DescribeContents() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midGetValueRequestDescribeContents == nil {
			callErr = fmt.Errorf("android.service.settings.preferences.GetValueRequest.describeContents is not available on this device")
			return callErr
		}
		result, callErr = env.CallIntMethod(
			m.Obj,
			midGetValueRequestDescribeContents,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *GetValueRequest) GetPreferenceKey() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midGetValueRequestGetPreferenceKey == nil {
			callErr = fmt.Errorf("android.service.settings.preferences.GetValueRequest.getPreferenceKey is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midGetValueRequestGetPreferenceKey,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *GetValueRequest) GetScreenKey() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midGetValueRequestGetScreenKey == nil {
			callErr = fmt.Errorf("android.service.settings.preferences.GetValueRequest.getScreenKey is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midGetValueRequestGetScreenKey,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *GetValueRequest) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midGetValueRequestToString == nil {
			callErr = fmt.Errorf("android.service.settings.preferences.GetValueRequest.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midGetValueRequestToString,
		)
		if callErr != nil {
			return callErr
		}
