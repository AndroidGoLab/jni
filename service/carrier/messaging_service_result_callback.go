...
func (m *MessagingServiceResultCallback) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midMessagingServiceResultCallbackToString == nil {
			callErr = fmt.Errorf("android.service.carrier.CarrierMessagingService$ResultCallback.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midMessagingServiceResultCallbackToString,
		)
		if callErr != nil {
			return callErr
		}
