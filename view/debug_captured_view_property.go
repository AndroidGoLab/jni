...
func (m *DebugCapturedViewProperty) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midDebugCapturedViewPropertyToString == nil {
			callErr = fmt.Errorf("android.view.ViewDebug$CapturedViewProperty.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midDebugCapturedViewPropertyToString,
		)
		if callErr != nil {
			return callErr
		}
