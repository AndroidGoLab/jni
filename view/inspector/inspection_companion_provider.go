...
type InspectionCompanionProvider struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *InspectionCompanionProvider) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midInspectionCompanionProviderToString == nil {
			callErr = fmt.Errorf("android.view.inspector.InspectionCompanionProvider.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midInspectionCompanionProviderToString,
		)
		if callErr != nil {
			return callErr
		}
