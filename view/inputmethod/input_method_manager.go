...
func (m *InputMethodManager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midInputMethodManagerToString == nil {
			callErr = fmt.Errorf("android.view.inputmethod.InputMethodManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midInputMethodManagerToString,
		)
		if callErr != nil {
			return callErr
		}
