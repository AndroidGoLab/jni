...
func (m *BounceInterpolator) GetInterpolation(arg0 float32) (float32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midBounceInterpolatorGetInterpolation == nil {
			callErr = fmt.Errorf("android.view.animation.BounceInterpolator.getInterpolation is not available on this device")
			return callErr
		}

		result, callErr = env.CallFloatMethod(
			m.Obj,
			midBounceInterpolatorGetInterpolation, jni.FloatValue(arg0),
		)
		if callErr != nil {
			return callErr
		}
...
func (m *BounceInterpolator) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midBounceInterpolatorToString == nil {
			callErr = fmt.Errorf("android.view.animation.BounceInterpolator.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midBounceInterpolatorToString,
		)
		if callErr != nil {
			return callErr
		}
