...
func (m *BaseInterpolator) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midBaseInterpolatorToString == nil {
			callErr = fmt.Errorf("android.view.animation.BaseInterpolator.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midBaseInterpolatorToString,
		)
		if callErr != nil {
			return callErr
		}
