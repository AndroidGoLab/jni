...
func NewAccelerateInterpolator(vm *jni.VM, arg0 *jni.Object, arg1 *jni.Object) (*AccelerateInterpolator, error) {
	...
	err := vm.Do(func(env *jni.Env) error {
		...
		obj, err := env.NewObject((*jni.Class)(unsafe.Pointer(clsAccelerateInterpolator)), midAccelerateInterpolatorCtor, jni.ObjectValue(arg0), jni.ObjectValue(arg1))
		if err != nil {
			return err
		}
...
func (m *AccelerateInterpolator) GetInterpolation(arg0 float32) (float32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAccelerateInterpolatorGetInterpolation == nil {
			callErr = fmt.Errorf("android.view.animation.AccelerateInterpolator.getInterpolation is not available on this device")
			return callErr
		}

		result, callErr = env.CallFloatMethod(
			m.Obj,
			midAccelerateInterpolatorGetInterpolation, jni.FloatValue(arg0),
		)
		if callErr != nil {
			return callErr
		}
...
func (m *AccelerateInterpolator) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAccelerateInterpolatorToString == nil {
			callErr = fmt.Errorf("android.view.animation.AccelerateInterpolator.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAccelerateInterpolatorToString,
		)
		if callErr != nil {
			return callErr
		}
