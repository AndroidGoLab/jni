...
func (m *SurfaceControlInputReceiver) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSurfaceControlInputReceiverToString == nil {
			callErr = fmt.Errorf("android.view.SurfaceControlInputReceiver.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSurfaceControlInputReceiverToString,
		)
		if callErr != nil {
			return callErr
		}
