...
func (m *HapticFeedbackConstants) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midHapticFeedbackConstantsToString == nil {
			callErr = fmt.Errorf("android.view.HapticFeedbackConstants.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midHapticFeedbackConstantsToString,
		)
		if callErr != nil {
			return callErr
		}
