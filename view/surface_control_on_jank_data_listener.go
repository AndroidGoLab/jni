...
func (m *SurfaceControlOnJankDataListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSurfaceControlOnJankDataListenerToString == nil {
			callErr = fmt.Errorf("android.view.SurfaceControl$OnJankDataListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSurfaceControlOnJankDataListenerToString,
		)
		if callErr != nil {
			return callErr
		}
