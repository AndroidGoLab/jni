...
func (m *ChoreographerVsyncCallback) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midChoreographerVsyncCallbackToString == nil {
			callErr = fmt.Errorf("android.view.Choreographer$VsyncCallback.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midChoreographerVsyncCallbackToString,
		)
		if callErr != nil {
			return callErr
		}
