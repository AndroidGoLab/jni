...
func (m *AttachedSurfaceControlOnBufferTransformHintChangedListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAttachedSurfaceControlOnBufferTransformHintChangedListenerToString == nil {
			callErr = fmt.Errorf("android.view.AttachedSurfaceControl$OnBufferTransformHintChangedListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAttachedSurfaceControlOnBufferTransformHintChangedListenerToString,
		)
		if callErr != nil {
			return callErr
		}
