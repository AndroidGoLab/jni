...
func (m *ViewBaseSavedState) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midViewBaseSavedStateToString == nil {
			callErr = fmt.Errorf("android.view.View$BaseSavedState.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midViewBaseSavedStateToString,
		)
		if callErr != nil {
			return callErr
		}
