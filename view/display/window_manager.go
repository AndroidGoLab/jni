...
// ToString calls android.view.WindowManager.toString.
func (m *WindowManager) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midWindowManagerToString == nil {
			callErr = fmt.Errorf("android.view.WindowManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWindowManagerToString,
		)
		if callErr != nil {
			return callErr
		}
