...
func (m *SurfaceControlTransactionCommittedListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSurfaceControlTransactionCommittedListenerToString == nil {
			callErr = fmt.Errorf("android.view.SurfaceControl$TransactionCommittedListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSurfaceControlTransactionCommittedListenerToString,
		)
		if callErr != nil {
			return callErr
		}
