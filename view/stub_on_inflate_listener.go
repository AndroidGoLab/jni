...
func (m *StubOnInflateListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midStubOnInflateListenerToString == nil {
			callErr = fmt.Errorf("android.view.ViewStub$OnInflateListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midStubOnInflateListenerToString,
		)
		if callErr != nil {
			return callErr
		}
