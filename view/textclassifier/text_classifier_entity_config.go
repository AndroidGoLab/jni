...
// GetHints calls android.view.textclassifier.TextClassifier$EntityConfig.getHints.
func (m *TextClassifierEntityConfig) GetHints() (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midTextClassifierEntityConfigGetHints == nil {
			callErr = fmt.Errorf("android.view.textclassifier.TextClassifier$EntityConfig.getHints is not available on this device")
			return callErr
		}
		result, callErr = env.CallObjectMethod(
			m.Obj,
			midTextClassifierEntityConfigGetHints,
		)
		if callErr != nil {
			return callErr
		}
...
func (m *TextClassifierEntityConfig) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midTextClassifierEntityConfigToString == nil {
			callErr = fmt.Errorf("android.view.textclassifier.TextClassifier$EntityConfig.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midTextClassifierEntityConfigToString,
		)
		if callErr != nil {
			return callErr
		}
