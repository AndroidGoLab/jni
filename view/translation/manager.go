...
func (m *Manager) GetOnDeviceTranslationSettingsActivityIntent() (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerGetOnDeviceTranslationSettingsActivityIntent == nil {
			callErr = fmt.Errorf("android.view.translation.TranslationManager.getOnDeviceTranslationSettingsActivityIntent is not available on this device")
			return callErr
		}
		result, callErr = env.CallObjectMethod(
			m.Obj,
			midManagerGetOnDeviceTranslationSettingsActivityIntent,
		)
		if callErr != nil {
			return callErr
		}
...
// ToString calls android.view.translation.TranslationManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.view.translation.TranslationManager.toString is not available on this device")
			return callErr
		}
