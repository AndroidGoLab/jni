...
func (m *OnReceiveContentListener) OnReceiveContent(arg0 *jni.Object, arg1 *jni.Object) (*jni.Object, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midOnReceiveContentListenerOnReceiveContent == nil {
			callErr = fmt.Errorf("android.view.OnReceiveContentListener.onReceiveContent is not available on this device")
			return callErr
		}
...
func (m *OnReceiveContentListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midOnReceiveContentListenerToString == nil {
			callErr = fmt.Errorf("android.view.OnReceiveContentListener.toString is not available on this device")
			return callErr
		}
