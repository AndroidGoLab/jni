...
// ToString calls android.view.textservice.TextServicesManager.toString.
func (m *TextServicesManager) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midTextServicesManagerToString == nil {
			callErr = fmt.Errorf("android.view.textservice.TextServicesManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midTextServicesManagerToString,
		)
		if callErr != nil {
			return callErr
		}
