...
func (m *ContextMenuContextMenuInfo) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContextMenuContextMenuInfoToString == nil {
			callErr = fmt.Errorf("android.view.ContextMenu$ContextMenuInfo.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContextMenuContextMenuInfoToString,
		)
		if callErr != nil {
			return callErr
		}
