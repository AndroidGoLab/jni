...
func (m *TreeObserverOnGlobalFocusChangeListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midTreeObserverOnGlobalFocusChangeListenerToString == nil {
			callErr = fmt.Errorf("android.view.ViewTreeObserver$OnGlobalFocusChangeListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midTreeObserverOnGlobalFocusChangeListenerToString,
		)
		if callErr != nil {
			return callErr
		}
