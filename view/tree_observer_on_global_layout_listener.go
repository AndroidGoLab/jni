...
func (m *TreeObserverOnGlobalLayoutListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midTreeObserverOnGlobalLayoutListenerToString == nil {
			callErr = fmt.Errorf("android.view.ViewTreeObserver$OnGlobalLayoutListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midTreeObserverOnGlobalLayoutListenerToString,
		)
		if callErr != nil {
			return callErr
		}
