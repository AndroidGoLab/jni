...
const serviceNameManager = "keyguard"
...
// ToString calls android.app.KeyguardManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.app.KeyguardManager.toString is not available on this device")
			return callErr
		}
