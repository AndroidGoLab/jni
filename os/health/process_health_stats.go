...
func (m *ProcessHealthStats) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midProcessHealthStatsToString == nil {
			callErr = fmt.Errorf("android.os.health.ProcessHealthStats.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midProcessHealthStatsToString,
		)
		if callErr != nil {
			return callErr
		}
