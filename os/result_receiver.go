...
func (m *ResultReceiver) DescribeContents() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midResultReceiverDescribeContents == nil {
			callErr = fmt.Errorf("android.os.ResultReceiver.describeContents is not available on this device")
			return callErr
		}
...
func (m *ResultReceiver) Send(arg0 int32, arg1 *jni.Object) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midResultReceiverSend == nil {
			callErr = fmt.Errorf("android.os.ResultReceiver.send is not available on this device")
			return callErr
		}
...
func (m *ResultReceiver) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midResultReceiverToString == nil {
			callErr = fmt.Errorf("android.os.ResultReceiver.toString is not available on this device")
			return callErr
		}
