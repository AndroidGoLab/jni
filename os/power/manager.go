...
const serviceNameManager = "power"
...
// ToString calls android.os.PowerManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.os.PowerManager.toString is not available on this device")
			return callErr
		}
