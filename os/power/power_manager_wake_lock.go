...
// powerManagerWakeLock wraps android.os.PowerManager$WakeLock.
type powerManagerWakeLock struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}

// Acquire0 calls android.os.PowerManager$WakeLock.acquire.
func (m *powerManagerWakeLock) Acquire0() error {
...
func (m *powerManagerWakeLock) Acquire1_1(arg0 int64) error {
	...
	m.VM.Do(func(env *jni.Env) error {
		...
		callErr = env.CallVoidMethod(
			m.Obj,
			midpowerManagerWakeLockAcquire1_1, jni.LongValue(arg0),
		)
		return callErr
	})
	return callErr
...
func (m *powerManagerWakeLock) IsHeld() (bool, error) {
	var result bool
	var callErr error
	m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
...
func (m *powerManagerWakeLock) Release0() error {
...
func (m *powerManagerWakeLock) Release1_1(arg0 int32) error {
	...
	m.VM.Do(func(env *jni.Env) error {
		...
		callErr = env.CallVoidMethod(
			m.Obj,
			midpowerManagerWakeLockRelease1_1, jni.IntValue(arg0),
		)
		return callErr
	})
	return callErr
...
func (m *powerManagerWakeLock) SetReferenceCounted(arg0 bool) error {
	...
	m.VM.Do(func(env *jni.Env) error {
		...
		callErr = env.CallVoidMethod(
			m.Obj,
			midpowerManagerWakeLockSetReferenceCounted, jni.BooleanValue(jArg0),
		)
		return callErr
	})
	return callErr
...
func (m *powerManagerWakeLock) SetStateListener(arg0 *jni.Object, arg1 *jni.Object) error {
	...
	m.VM.Do(func(env *jni.Env) error {
		...
		callErr = env.CallVoidMethod(
			m.Obj,
			midpowerManagerWakeLockSetStateListener, jni.ObjectValue(arg0), jni.ObjectValue(arg1),
		)
		return callErr
	})
	return callErr
...
func (m *powerManagerWakeLock) SetWorkSource(arg0 *jni.Object) error {
	...
	m.VM.Do(func(env *jni.Env) error {
		...
		callErr = env.CallVoidMethod(
			m.Obj,
			midpowerManagerWakeLockSetWorkSource, jni.ObjectValue(arg0),
		)
		return callErr
	})
	return callErr
...
func (m *powerManagerWakeLock) ToString() (string, error) {
	var result string
	var callErr error
	m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		resultObj, callErr := env.CallObjectMethod(
			m.Obj,
			midpowerManagerWakeLockToString,
		)
		if callErr != nil {
			return callErr
		}
