...
func (m *UnbufferedIoViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUnbufferedIoViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.UnbufferedIoViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUnbufferedIoViolationToString,
		)
		if callErr != nil {
			return callErr
		}
