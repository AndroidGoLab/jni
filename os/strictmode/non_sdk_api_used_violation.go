...
func (m *NonSdkApiUsedViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midNonSdkApiUsedViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.NonSdkApiUsedViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midNonSdkApiUsedViolationToString,
		)
		if callErr != nil {
			return callErr
		}
