...
func (m *IntentReceiverLeakedViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midIntentReceiverLeakedViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.IntentReceiverLeakedViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midIntentReceiverLeakedViolationToString,
		)
		if callErr != nil {
			return callErr
		}
