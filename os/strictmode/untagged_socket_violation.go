...
func (m *UntaggedSocketViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midUntaggedSocketViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.UntaggedSocketViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midUntaggedSocketViolationToString,
		)
		if callErr != nil {
			return callErr
		}
