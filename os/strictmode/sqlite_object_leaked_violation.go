...
func (m *SqliteObjectLeakedViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midSqliteObjectLeakedViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.SqliteObjectLeakedViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midSqliteObjectLeakedViolationToString,
		)
		if callErr != nil {
			return callErr
		}
