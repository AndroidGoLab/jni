...
func (m *FileUriExposedViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midFileUriExposedViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.FileUriExposedViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midFileUriExposedViolationToString,
		)
		if callErr != nil {
			return callErr
		}
