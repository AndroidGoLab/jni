...
func (m *NetworkViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midNetworkViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.NetworkViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midNetworkViolationToString,
		)
		if callErr != nil {
			return callErr
		}
