...
func (m *CustomViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midCustomViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.CustomViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midCustomViolationToString,
		)
		if callErr != nil {
			return callErr
		}
