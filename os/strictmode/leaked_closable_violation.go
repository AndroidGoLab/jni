...
func (m *LeakedClosableViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midLeakedClosableViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.LeakedClosableViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midLeakedClosableViolationToString,
		)
		if callErr != nil {
			return callErr
		}
