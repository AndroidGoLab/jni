...
func (m *DiskReadViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midDiskReadViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.DiskReadViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midDiskReadViolationToString,
		)
		if callErr != nil {
			return callErr
		}
