...
func (m *ResourceMismatchViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midResourceMismatchViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.ResourceMismatchViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midResourceMismatchViolationToString,
		)
		if callErr != nil {
			return callErr
		}
