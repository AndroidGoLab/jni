...
func NewIncorrectContextUseViolation(vm *jni.VM, arg0 string, arg1 *jni.Object) (*IncorrectContextUseViolation, error) {
	...
	err := vm.Do(func(env *jni.Env) error {
		...
		obj, err := env.NewObject((*jni.Class)(unsafe.Pointer(clsIncorrectContextUseViolation)), midIncorrectContextUseViolationInit, jni.ObjectValue(&jArg0.Object), jni.ObjectValue(arg1))
		if err != nil {
			return err
		}
