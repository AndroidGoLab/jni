...
func (m *DiskWriteViolation) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midDiskWriteViolationToString == nil {
			callErr = fmt.Errorf("android.os.strictmode.DiskWriteViolation.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midDiskWriteViolationToString,
		)
		if callErr != nil {
			return callErr
		}
