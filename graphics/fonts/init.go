...
var (
	...
	midFontVariationAxisInit                      jni.MethodID
...
func doInit(env *jni.Env) error {
	...
	if err != nil {
		...
		midFontStyleInit, err = env.GetMethodID((*jni.Class)(unsafe.Pointer(clsFontStyle)), "<init>", "()V")
		if err != nil {
			env.ExceptionClear()
		}
	...
	if err != nil {
		...
		midFontVariationAxisInit, err = env.GetMethodID((*jni.Class)(unsafe.Pointer(clsFontVariationAxis)), "<init>", "(Ljava/lang/String;F)V")
		if err != nil {
			env.ExceptionClear()
		}
