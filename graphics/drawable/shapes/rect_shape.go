...
// ToString calls android.graphics.drawable.shapes.RectShape.toString.
func (m *RectShape) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midRectShapeToString == nil {
			callErr = fmt.Errorf("android.graphics.drawable.shapes.RectShape.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midRectShapeToString,
		)
		if callErr != nil {
			return callErr
		}
