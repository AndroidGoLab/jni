...
// ToString calls android.graphics.ComposeShader.toString.
func (m *ComposeShader) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midComposeShaderToString == nil {
			callErr = fmt.Errorf("android.graphics.ComposeShader.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midComposeShaderToString,
		)
		if callErr != nil {
			return callErr
		}
