...
// ToString calls android.graphics.PorterDuff.toString.
func (m *PorterDuff) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midPorterDuffToString == nil {
			callErr = fmt.Errorf("android.graphics.PorterDuff.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midPorterDuffToString,
		)
		if callErr != nil {
			return callErr
		}
