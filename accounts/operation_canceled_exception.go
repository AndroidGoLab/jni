...
// ToString calls android.accounts.OperationCanceledException.toString.
func (m *OperationCanceledException) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midOperationCanceledExceptionToString == nil {
			callErr = fmt.Errorf("android.accounts.OperationCanceledException.toString is not available on this device")
			return callErr
		}
