...
// ToString calls android.se.omapi.Reader.toString.
func (m *Reader) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midReaderToString == nil {
			callErr = fmt.Errorf("android.se.omapi.Reader.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
