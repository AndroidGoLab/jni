...
| Project | Relation |
|---|---|
| [`xaionaro-go/ndk`](https://github.com/xaionaro-go/ndk) | Go bindings for Android NDK C APIs (camera, audio, sensors, etc.) |
| [`xaionaro-go/aidl`](https://github.com/xaionaro-go/aidl) | AIDL compiler and Binder IPC runtime for Go |
