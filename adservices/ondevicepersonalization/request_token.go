...
func (m *RequestToken) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midRequestTokenToString == nil {
			callErr = fmt.Errorf("android.adservices.ondevicepersonalization.RequestToken.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midRequestTokenToString,
		)
		if callErr != nil {
			return callErr
		}
