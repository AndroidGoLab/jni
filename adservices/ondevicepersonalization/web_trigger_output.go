...
func (m *WebTriggerOutput) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midWebTriggerOutputToString == nil {
			callErr = fmt.Errorf("android.adservices.ondevicepersonalization.WebTriggerOutput.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWebTriggerOutputToString,
		)
		if callErr != nil {
			return callErr
		}
