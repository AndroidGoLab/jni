...
// ToString calls android.adservices.measurement.DeletionRequest.toString.
func (m *DeletionRequest) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midDeletionRequestToString == nil {
			callErr = fmt.Errorf("android.adservices.measurement.DeletionRequest.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midDeletionRequestToString,
		)
		if callErr != nil {
			return callErr
		}
