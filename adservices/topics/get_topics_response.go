...
// ToString calls android.adservices.topics.GetTopicsResponse.toString.
func (m *GetTopicsResponse) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midGetTopicsResponseToString == nil {
			callErr = fmt.Errorf("android.adservices.topics.GetTopicsResponse.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midGetTopicsResponseToString,
		)
		if callErr != nil {
			return callErr
		}
