...
// getLightsRaw calls android.hardware.lights.LightsManager.getLights.
func (m *Manager) getLightsRaw() (*jni.Object, error) {
...
// openSessionRaw calls android.hardware.lights.LightsManager.openSession.
func (m *Manager) openSessionRaw() (*jni.Object, error) {
	var result *jni.Object
	var callErr error
	m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
