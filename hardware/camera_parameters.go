...
// ToString calls android.hardware.Camera$Parameters.toString.
func (m *CameraParameters) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midCameraParametersToString == nil {
			callErr = fmt.Errorf("android.hardware.Camera$Parameters.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midCameraParametersToString,
		)
		if callErr != nil {
			return callErr
		}
