...
// ToString calls android.hardware.camera2.CameraManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.hardware.camera2.CameraManager.toString is not available on this device")
			return callErr
		}
