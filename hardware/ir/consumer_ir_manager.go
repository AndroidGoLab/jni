...
// ToString calls android.hardware.ConsumerIrManager.toString.
func (m *ConsumerIrManager) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midConsumerIrManagerToString == nil {
			callErr = fmt.Errorf("android.hardware.ConsumerIrManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midConsumerIrManagerToString,
		)
		if callErr != nil {
			return callErr
		}
