...
func (m *ManagerAuthenticationResult) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerAuthenticationResultToString == nil {
			callErr = fmt.Errorf("android.hardware.fingerprint.FingerprintManager$AuthenticationResult.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midManagerAuthenticationResultToString,
		)
		if callErr != nil {
			return callErr
		}
