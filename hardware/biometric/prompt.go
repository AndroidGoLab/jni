...
// ToString calls android.hardware.biometrics.BiometricPrompt.toString.
func (m *Prompt) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midPromptToString == nil {
			callErr = fmt.Errorf("android.hardware.biometrics.BiometricPrompt.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
