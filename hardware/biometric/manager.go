...
const serviceNameManager = "biometric"
...
// ToString calls android.hardware.biometrics.BiometricManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.hardware.biometrics.BiometricManager.toString is not available on this device")
			return callErr
		}
