...
// ToString calls android.hardware.input.InputManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.hardware.input.InputManager.toString is not available on this device")
			return callErr
		}
