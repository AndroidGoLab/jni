...
type NoAuthenticationKeyAvailableException struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func NewNoAuthenticationKeyAvailableException(vm *jni.VM, arg0 string) (*NoAuthenticationKeyAvailableException, error) {
	var t NoAuthenticationKeyAvailableException
	t.VM = vm
...
// ToString calls android.security.identity.NoAuthenticationKeyAvailableException.toString.
func (m *NoAuthenticationKeyAvailableException) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midNoAuthenticationKeyAvailableExceptionToString == nil {
			callErr = fmt.Errorf("android.security.identity.NoAuthenticationKeyAvailableException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midNoAuthenticationKeyAvailableExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
