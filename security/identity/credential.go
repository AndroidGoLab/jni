...
// ToString calls android.security.identity.IdentityCredential.toString.
func (m *Credential) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midCredentialToString == nil {
			callErr = fmt.Errorf("android.security.identity.IdentityCredential.toString is not available on this device")
			return callErr
		}
