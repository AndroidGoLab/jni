...
func (m *ContractCalendars) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractCalendarsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$Calendars.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractCalendarsToString,
		)
		if callErr != nil {
			return callErr
		}
