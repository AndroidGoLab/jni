...
func (m *ContractEvents) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractEventsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$Events.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractEventsToString,
		)
		if callErr != nil {
			return callErr
		}
