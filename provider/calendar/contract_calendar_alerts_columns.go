...
func (m *ContractCalendarAlertsColumns) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractCalendarAlertsColumnsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$CalendarAlertsColumns.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractCalendarAlertsColumnsToString,
		)
		if callErr != nil {
			return callErr
		}
