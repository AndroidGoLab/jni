...
func (m *ContractEventsEntity) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractEventsEntityToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$EventsEntity.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractEventsEntityToString,
		)
		if callErr != nil {
			return callErr
		}
