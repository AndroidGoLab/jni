...
func (m *ContractColorsColumns) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractColorsColumnsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$ColorsColumns.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractColorsColumnsToString,
		)
		if callErr != nil {
			return callErr
		}
