...
func (m *ContractColors) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractColorsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$Colors.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractColorsToString,
		)
		if callErr != nil {
			return callErr
		}
