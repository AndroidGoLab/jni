...
func (m *ContractExtendedProperties) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractExtendedPropertiesToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$ExtendedProperties.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractExtendedPropertiesToString,
		)
		if callErr != nil {
			return callErr
		}
