...
func (m *ContractCalendarSyncColumns) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractCalendarSyncColumnsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$CalendarSyncColumns.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractCalendarSyncColumnsToString,
		)
		if callErr != nil {
			return callErr
		}
