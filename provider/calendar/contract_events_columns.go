...
func (m *ContractEventsColumns) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractEventsColumnsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$EventsColumns.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractEventsColumnsToString,
		)
		if callErr != nil {
			return callErr
		}
