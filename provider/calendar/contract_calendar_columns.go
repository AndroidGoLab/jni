...
func (m *ContractCalendarColumns) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midContractCalendarColumnsToString == nil {
			callErr = fmt.Errorf("android.provider.CalendarContract$CalendarColumns.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midContractCalendarColumnsToString,
		)
		if callErr != nil {
			return callErr
		}
