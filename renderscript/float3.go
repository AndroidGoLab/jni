...
// ToString calls android.renderscript.Float3.toString.
func (m *Float3) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midFloat3ToString == nil {
			callErr = fmt.Errorf("android.renderscript.Float3.toString is not available on this device")
			return callErr
		}
