...
// ToString calls android.renderscript.Long4.toString.
func (m *Long4) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midLong4ToString == nil {
			callErr = fmt.Errorf("android.renderscript.Long4.toString is not available on this device")
			return callErr
		}
