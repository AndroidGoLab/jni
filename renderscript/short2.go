...
// ToString calls android.renderscript.Short2.toString.
func (m *Short2) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midShort2ToString == nil {
			callErr = fmt.Errorf("android.renderscript.Short2.toString is not available on this device")
			return callErr
		}
