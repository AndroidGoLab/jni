...
func (m *WallpaperManagerOnColorsChangedListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midWallpaperManagerOnColorsChangedListenerToString == nil {
			callErr = fmt.Errorf("android.app.WallpaperManager$OnColorsChangedListener.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midWallpaperManagerOnColorsChangedListenerToString,
		)
		if callErr != nil {
			return callErr
		}
