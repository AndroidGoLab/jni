...
const serviceNameManager = "alarm"
...
// ToString calls android.app.AlarmManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.app.AlarmManager.toString is not available on this device")
			return callErr
		}
