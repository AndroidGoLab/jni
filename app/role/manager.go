...
// ToString calls android.app.role.RoleManager.toString.
func (m *Manager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midManagerToString == nil {
			callErr = fmt.Errorf("android.app.role.RoleManager.toString is not available on this device")
			return callErr
		}
