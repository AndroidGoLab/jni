...
func (m *ActivityManagerRunningServiceInfo) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midActivityManagerRunningServiceInfoToString == nil {
			callErr = fmt.Errorf("android.app.ActivityManager$RunningServiceInfo.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midActivityManagerRunningServiceInfoToString,
		)
		if callErr != nil {
			return callErr
		}
