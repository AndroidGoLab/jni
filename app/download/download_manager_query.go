...
// downloadManagerQuery wraps android.app.DownloadManager$Query.
type downloadManagerQuery struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}

// SetFilterById calls android.app.DownloadManager$Query.setFilterById.
func (m *downloadManagerQuery) SetFilterById(arg0 *jni.Object) (*jni.Object, error) {
	...
	m.VM.Do(func(env *jni.Env) error {
		...
		result, callErr = env.CallObjectMethod(
			m.Obj,
			middownloadManagerQuerySetFilterById, jni.ObjectValue(arg0),
		)
		if callErr != nil {
			return callErr
		}
...
func (m *downloadManagerQuery) SetFilterByStatus(arg0 int32) (*jni.Object, error) {
	var result *jni.Object
	var callErr error
	m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		result, callErr = env.CallObjectMethod(
			m.Obj,
			middownloadManagerQuerySetFilterByStatus, jni.IntValue(arg0),
		)
		if callErr != nil {
			return callErr
		}
