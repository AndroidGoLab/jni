...
// ToString calls android.app.usage.UsageStatsManager.toString.
func (m *StatsManager) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midStatsManagerToString == nil {
			callErr = fmt.Errorf("android.app.usage.UsageStatsManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midStatsManagerToString,
		)
		if callErr != nil {
			return callErr
		}
