...
func (m *GrammaticalInflectionManager) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midGrammaticalInflectionManagerToString == nil {
			callErr = fmt.Errorf("android.app.GrammaticalInflectionManager.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midGrammaticalInflectionManagerToString,
		)
		if callErr != nil {
			return callErr
		}
