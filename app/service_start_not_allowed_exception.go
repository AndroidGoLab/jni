...
func (m *ServiceStartNotAllowedException) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midServiceStartNotAllowedExceptionToString == nil {
			callErr = fmt.Errorf("android.app.ServiceStartNotAllowedException.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midServiceStartNotAllowedExceptionToString,
		)
		if callErr != nil {
			return callErr
		}
