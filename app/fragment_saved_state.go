...
func (m *FragmentSavedState) DescribeContents() (int32, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midFragmentSavedStateDescribeContents == nil {
			callErr = fmt.Errorf("android.app.Fragment$SavedState.describeContents is not available on this device")
			return callErr
		}
...
func (m *FragmentSavedState) WriteToParcel(arg0 *jni.Object, arg1 int32) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midFragmentSavedStateWriteToParcel == nil {
			callErr = fmt.Errorf("android.app.Fragment$SavedState.writeToParcel is not available on this device")
			return callErr
		}
...
func (m *FragmentSavedState) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midFragmentSavedStateToString == nil {
			callErr = fmt.Errorf("android.app.Fragment$SavedState.toString is not available on this device")
			return callErr
		}
