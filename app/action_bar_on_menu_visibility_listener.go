...
func (m *ActionBarOnMenuVisibilityListener) OnMenuVisibilityChanged(arg0 bool) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midActionBarOnMenuVisibilityListenerOnMenuVisibilityChanged == nil {
			callErr = fmt.Errorf("android.app.ActionBar$OnMenuVisibilityListener.onMenuVisibilityChanged is not available on this device")
			return callErr
		}
		var jArg0 uint8
		if arg0 {
...
func (m *ActionBarOnMenuVisibilityListener) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midActionBarOnMenuVisibilityListenerToString == nil {
			callErr = fmt.Errorf("android.app.ActionBar$OnMenuVisibilityListener.toString is not available on this device")
			return callErr
		}
